...
data = []
file_path = "1204_100data_maybeOK\margedata_formagsensor20241213_161528.pickle"
...
subset_df = df.head(8670)
print(subset_df)
column_to_plot = 'rotate3'

# グラフを作成
plt.figure(figsize=(8, 5))
plt.plot(subset_df.index, subset_df[column_to_plot], label=f'{column_to_plot} (First {1000} Rows)')

# グラフの装飾
plt.title(f"Plot of {column_to_plot} (First {1000} Rows)")
plt.xlabel("Index")
