...
def test(model, data_loader):
    model.eval()  # 評価モードに切り替え（DropoutやBatchNormが推論用に）
    ...
    return loss_mean / n_batches if n_batches > 0 else float('inf')
...
L = 30 
stride = 1
original_result_dir = r"Robomech_GRU\data30stride1type"
