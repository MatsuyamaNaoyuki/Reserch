...
#---------------------------------------------------------------------------------- --------------------------------------
    ...
    result_dir = r"C:\Users\WRS\Desktop\Matsuyama\laerningdataandresult\reretubefinger0819\alluse_stride1"
    ...
    kijunx, _ ,_= myfunction.read_pickle_to_torch(kijun_dir, True, True, True)
    ...
    x_data = Mydataset.apply_standardize_torch(xA_proc, x_mean, x_std)

    y_mean, y_std = Mydataset.fit_standardizer_torch(y_data)
    y_data = Mydataset.apply_standardize_torch(y_data, y_mean, y_std)
