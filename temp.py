...
#     ax.scatter(x[i], y[i], z[i], color=rcolors[i], s=20)  # sは点のサイズ


# for i in range(len(x0)):
#     print(x0[i],y0[i],z0[i])
#     ax.scatter(x0[i], y0[i], z0[i], color=bcolors[i], s=20)  # sは点のサイズ


# ax.plot(x, y, z, color='r', label='補正前')
# ax.plot(x0, y0, z0, color='b', label='補正後')
