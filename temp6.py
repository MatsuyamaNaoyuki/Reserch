...
label_rotate = ["left_motor", "right_motor", "center_motor", "back_motor"]
label_current = ["left_motor", "right_motor", "center_motor", "back_motor"]
...
ax3.set_ylabel("magsensor [ADC value]")
